...
def streamlit_app():
    st.image("titlebanner.png")
    
    # Centered and orange-colored text
    text_html = """
    <div style='text-align: center; color: orange;'>
        <h2>Welcome to our unique anime recommender system, designed with MyAnimeList's extensive library in mind!</h2>
        <p>Our app brings you three distinct lists of anime recommendations, each crafted through a different approach: item-based, user-based collaborative filtering, and content-based methodologies. To get started, we've selected five popular anime across a range of genres. If you're familiar with any of them, we'd love for you to rate them on a scale from 1 to 10. For those you haven't seen, simply leave the rating at 1. Dive in and discover your next favorite anime with us!</p>
    </div>
    """
    
    st.markdown(text_html, unsafe_allow_html=True)
    
    # Space or break between text and the next image
    st.write('\n')  # For a simple space
    # or
